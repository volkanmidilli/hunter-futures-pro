...
def _data_quality_to_dict(data_quality: ResearchRunDataQuality) -> dict[str, Any]:
    ...
    return {
        ...
        "controlled_universe_steps": data_quality.controlled_universe_steps,
        "controlled_universe_blocked": data_quality.controlled_universe_blocked,
        "controlled_universe_universe_count": data_quality.controlled_universe_universe_count,
        "controlled_universe_watchlist_count": data_quality.controlled_universe_watchlist_count,
        "controlled_universe_blocked_count": data_quality.controlled_universe_blocked_count,
...
def research_run_result_to_markdown_text(result: ResearchRunResult) -> str:
    ...
    lines: list[str] = [
        ...
        f"| controlled_universe_steps | {_md_value(dq.controlled_universe_steps)} |",
        f"| controlled_universe_blocked | {_md_value(dq.controlled_universe_blocked)} |",
        f"| controlled_universe_universe_count | {_md_value(dq.controlled_universe_universe_count)} |",
        f"| controlled_universe_watchlist_count | {_md_value(dq.controlled_universe_watchlist_count)} |",
        f"| controlled_universe_blocked_count | {_md_value(dq.controlled_universe_blocked_count)} |",
