...
# v0.71.0-rc.2 — ZIP safety reason codes (export_parser.py)
ZIP_ENCRYPTED_MEMBER = "ZIP_ENCRYPTED_MEMBER"
ZIP_DUPLICATE_MEMBER = "ZIP_DUPLICATE_MEMBER"
ZIP_ABSOLUTE_PATH = "ZIP_ABSOLUTE_PATH"
ZIP_PATH_TRAVERSAL = "ZIP_PATH_TRAVERSAL"
ZIP_BACKSLASH_TRAVERSAL = "ZIP_BACKSLASH_TRAVERSAL"
ZIP_SYMLINK_MEMBER = "ZIP_SYMLINK_MEMBER"
ZIP_SPECIAL_FILE_MEMBER = "ZIP_SPECIAL_FILE_MEMBER"
ZIP_EXCESSIVE_MEMBER_COUNT = "ZIP_EXCESSIVE_MEMBER_COUNT"
ZIP_OVERSIZED_MEMBER = "ZIP_OVERSIZED_MEMBER"
ZIP_EXCESSIVE_TOTAL_SIZE = "ZIP_EXCESSIVE_TOTAL_SIZE"
ZIP_BOMB_SUSPECTED = "ZIP_BOMB_SUSPECTED"
ZIP_MISSING_EXPECTED_MEMBER = "ZIP_MISSING_EXPECTED_MEMBER"
ZIP_AMBIGUOUS_JSON_MEMBERS = "ZIP_AMBIGUOUS_JSON_MEMBERS"
...
RESEARCH_BACKTEST_COMPARISON_REASON_CODES: frozenset[str] = frozenset(
    {
        ...
        # v0.71.0-rc.2 — ZIP safety reason codes
